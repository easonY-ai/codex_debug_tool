...
export const traceNodes: Node[] = [
  ...
  { id: 'request-1', title: '模型请求 · 首轮', source: 'OTel 执行', lane: 'API / TTFT', start: 0.7, end: 0.7, state: '已发起', content: '请求事件与性能 Span 共享合成请求身份。', raw: { event: 'codex.api_request', request_id: 'request-demo-1', 'turn.id': id.turn } },
  { id: 'api-1', title: '模型 API Span', source: 'OTel 性能', lane: 'API / TTFT', start: 0.7, end: 7.4, operationId: 'request-1', state: '完成', content: 'TTFT 2.3 秒；客户端端到端 6.7 秒', raw: { trace_id: 'trace-demo-parallel', span_id: 'span-demo-api-1', request_id: 'request-demo-1', 'turn.id': id.turn, duration_ms: 6700, ttft_ms: 2300 } },
  ...
  { id: 'orphan-span', title: '未匹配本地处理 Span', source: 'OTel 性能', lane: '本地处理', start: 8.1, end: 9.2, state: '完成', content: '只有 Turn 身份，没有可验证的操作关联。', evidence: '保留原始 Span；不按时间最近项挂到工具决策或 Tool Call。', raw: { trace_id: 'trace-demo-parallel', span_id: 'span-demo-local', parent_span_id: 'span-demo-turn', 'turn.id': id.turn, start_ms: 8100, end_ms: 9200 } },
  ...
  { id: 'tool-span', title: '工具调用整体 Span', source: 'OTel 性能', lane: '工具调用', start: 10, end: 31, operationId: 'tool-parent', state: '完成', evidence: '合成工具 Span 使用已验证的调用身份关联；父区间计入工具耗时一次。', raw: { trace_id: 'trace-demo-parallel', span_id: 'span-demo-tool', call_id: id.call, start_ms: 10000, end_ms: 31000 } },
  { id: 'tool-child-span', title: '工具子执行 Span', source: 'OTel 性能', lane: '工具调用', start: 11.5, end: 28, operationId: 'tool-parent', state: '完成', evidence: '同一合成调用身份；parent_span_id 仅表达 OTel 观测链，耗时不与父 Span 相加。', raw: { trace_id: 'trace-demo-parallel', span_id: 'span-demo-tool-child', parent_span_id: 'span-demo-tool', call_id: id.call, start_ms: 11500, end_ms: 28000 } },
  ...
  { id: 'request-2', title: '模型请求 · 汇总', source: 'OTel 执行', lane: 'API / TTFT', start: 31.3, end: 31.3, state: '已发起', raw: { event: 'codex.api_request', request_id: 'request-demo-2', 'turn.id': id.turn } },
  { id: 'api-2', title: '模型汇总 Span', source: 'OTel 性能', lane: 'API / TTFT', start: 31.3, end: 40, operationId: 'request-2', state: '完成', content: '客户端端到端 8.7 秒', raw: { trace_id: 'trace-demo-parallel', span_id: 'span-demo-api-2', request_id: 'request-demo-2', 'turn.id': id.turn, duration_ms: 8700 } },
...
export const extraNodes: Record<string, Node[]> = {
  'turn-demo-101': [
    ...
    { id: 'request-a', title: '模型请求 · 首轮', source: 'OTel 执行', lane: 'API / TTFT', start: 1, end: 1, state: '已发起', raw: { event: 'codex.api_request', request_id: 'request-demo-payment-1' } },
    { id: 'api-a', title: '模型 API Span', source: 'OTel 性能', lane: 'API / TTFT', start: 1, end: 16, operationId: 'request-a', state: '完成', content: 'TTFT 4.1 秒', raw: { span_id: 'span-demo-payment-api-1', request_id: 'request-demo-payment-1', ttft_ms: 4100 } },
    ...
    { id: 'tool-a-span', title: '工具调用 Span', source: 'OTel 性能', lane: '工具调用', start: 17, end: 59, operationId: 'tool-a', state: '完成', raw: { span_id: 'span-demo-payment-tool', call_id: 'call-demo-payment', duration_ms: 42000 } },
    { id: 'request-b', title: '模型请求 · 最终回复', source: 'OTel 执行', lane: 'API / TTFT', start: 59, end: 59, state: '已发起', raw: { event: 'codex.api_request', request_id: 'request-demo-payment-2' } },
    { id: 'api-b', title: '最终模型请求 Span', source: 'OTel 性能', lane: 'API / TTFT', start: 59, end: 77, operationId: 'request-b', state: '完成', raw: { span_id: 'span-demo-payment-api-2', request_id: 'request-demo-payment-2', duration_ms: 18000 } },
